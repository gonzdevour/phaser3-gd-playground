...
function setUpIMA() {
    ...
    adsRequest.adTagUrl = 'https://googleads.g.doubleclick.net/pagead/ads?ad_type=video_text_image&client=ca-games-pub-7380101976321108&description_url=http%3A%2F%2Fsales-frontier.com&videoad_start_delay=0&hl=zh_TW&max_ad_duration=30000&vad_type=nonlinear&adtest=on';
...
function onAdsManagerLoaded(adsManagerLoadedEvent) {
    ...
    adsManager = adsManagerLoadedEvent.getAdsManager(
        adDisplayContainer, adsRenderingSettings);
