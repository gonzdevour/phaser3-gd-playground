import CsvToHashTable from 'rexnotePlugins/csvtohashtable.js';
import mustache from "mustache";
import AppLang from 'gdkPlugins/utils/language/AppLang.js';
...
class TableLocalization extends CsvToHashTable {
  ...
  loc(key, view) {
    ...
    var langFromLs = this.lsData.get('appLang');
