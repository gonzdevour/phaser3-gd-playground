...
import IsPlainObjectArray from 'gdkPlugins/utils/object/IsPlainObjectArray.js';
...
var DialogDefault = function (scene, cfg) {
  ...
  var defaultValueConfig = {
    ...
    space: { 
        ...
        bottom: 20, 
        item: 20, 
        title: 20,//title下方要給多少空間
        titleLeft: 0,
        titleRight: 0,
        titleTop: 0,
        content: 60, //content下方要給多少空間
        contentLeft: 0,
        contentRight: 0,
        description: 0,
        descriptionLeft: 0,
    ...
    cover: {color:0x0, alpha: 0.9, transitIn(cover, dur){}, transitOut(cover, dur) {},}, //#663030
